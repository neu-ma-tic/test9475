...
class music_cog(commands.Cog):
    ...
    async def p(self, ctx, *args):
        ...
        if voice_channel is None:
            ...
            if type(song) == type(True):
                ...
                await ctx.send(self.music_queue[1])
    ...
    @commands.command(name="Help", help="YES BE")
    async def helping(self, ctx):
          self.help_list = (""":olive: ***Thanks for using Zeytin*** :olive:
--------------------------------------------------
**play, p:** Plays the music from Youtube.
...
**disconnect, dc:** Disconnecting bot from voice
**clear:** Clearing queue""")
          await ctx.send(self.help_list)

    @commands.command(name="p")
    async def p2(self, ctx, *args):
        query = " ".join(args)
