                    ...
                    try:
                        ...
                        async with ctx.typing():
                            try:
                                ...
                                song = Song(source)
                                self.current = song
                                await ctx.send('Enqueued {}'.format(
                                    str(source)))
...
class Music(commands.Cog):
    ...
    async def _loop(self, ctx: commands.Context):
        ...
        await ctx.message.add_reaction('✅')
        await ctx.send('Looping a song is now turned ' +
                       ('on' if ctx.voice_state.loop else 'off'))
    ...
    async def _autoplay(self, ctx: commands.Context):
        ...
        await ctx.message.add_reaction('✅')
        await ctx.send('Autoplay after end of queue is now ' +
