...
@bot.command()
async def help_fan(ctx):
    embed5 = discord.Embed(title='🌿 | весёлости',
                           description=f'''
		```
―-―-―-―ФПК РДЖ―-―-―-―
{prefix}popit - поп ит(скоро)
{prefix}gg - да или нет
{prefix}ball - выдаёт рандомный ответ```
		''',
                           color=0x466db3)
...
keep_alive()
bot.run('OTkzNTgzMjcxNTE2NTgyMDM5.GYz6Gf.v86hg2ICt_f-jJko_VzsWhoAh2OGyDq8e-vcuA')