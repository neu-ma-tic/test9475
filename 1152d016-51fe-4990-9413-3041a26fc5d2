...
var config = { // NOTE: DO NOT LEAVE ANYTHING BLANK
	...
	ownerID: '711247554855305278', // Your ID here
	token: 'ODU4OTk2Nzg2Mzg3NjE1NzU0.YNmRGQ.y7kvrmJ2lAtLnNt3s2B6a0jEedA', // Your bot token here
	...
	cleverbotToken: 'AIzaSyBmKLYGM3rqRmTQKNGQJaBKUR6ZXG-j3Ds', // API Token for CleverBot
  googleAPIToken: 'AIzaSyBmKLYGM3rqRmTQKNGQJaBKUR6ZXG-j3Ds', // Used for link shortener and music features. You need to have these APIs enabled.
  ...
  musicEnabled: 'true',
	...
	dashboard: {
		...
		oauthSecret: 'j2h3YLTXCbajHXy5I4oGrJos2NblHpKK', // The client secret from the Discord bot page
		secure: 'true', // HTTPS: 'true' for true, 'false' for false
		sessionSecret: 'G4IU3T7H3459HH7', // Go crazy on the keyboard here, this is used as a session secret
