...
chrome.webRequest.onHeadersReceived.addListener(
	(details) => {
		if (chr) if (details.initiator !== "https://discord-bot-client-1.omglongsn.repl.co") return;
		if (fir) if (!details.originUrl.includes("discord-bot-client-1.omglongsn.repl.co")) return;
