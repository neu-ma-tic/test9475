<?php
$app->post('/api/DiscordBot/executeWebhookEmbed', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['webhookToken', 'webhookId', 'embeds']);
    ...
    $body['embeds'] = $post_data['args']['embeds'];
