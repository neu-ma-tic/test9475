<?php
$app->post('/api/DiscordBot/updateCurrentUser', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . '/users/@me';
    ...
    if(isset($post_data['args']['avatar']) && strlen($post_data['args']['avatar']) > 0){
        $body['avatar'] = base64_encode(file_get_contents($post_data['args']['avatar']));
    }
